...
| Hard delete | `DELETE /Endpoint/{id}/$template` | No — permanently removes the resource | Supplier product is fully decommissioned and the Template will never be needed again. **Requires admin access.** |
